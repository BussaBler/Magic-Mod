...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NitorEntity>> NITOR_BE = BLOCK_ENTITIES.register("nitor_block_entity", ()-> BlockEntityType.Builder.
    of(NitorEntity::new, ModBlocks.NITOR.get(), ModBlocks.PURPLE_NITOR.get(), ModBlocks.GREEN_NITOR.get(), ModBlocks.BLUE_NITOR.get(), ModBlocks.PINK_NITOR.get(), ModBlocks.RED_NITOR.get(), ModBlocks.BLACK_NITOR.get()
    , ModBlocks.WHITE_NITOR.get()).build(null));
